...
class Service
{
    ...
    public function updateUser(User $user, $data)
    {
        ...
        $user->sum_lucre_conf = $data['sum_lucre_conf'] ?? '';
        $user->everyday_conf = $data['everyday_conf'] ?? '';
        $user->sum_lucre = $data['sum_lucre'] ?? '';
        $user->everyday = $data['everyday'] ?? '';
        $user->kg_conf = $data['kg_conf'] ?? '';
        $user->kg = $data['kg'] ?? '';
        $user->three = $data['three'] ?? '';
        $user->three_conf = $data['three_conf'] ?? '';
        $user->total = $data['total'] ?? 1;
