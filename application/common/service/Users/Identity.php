...
//                'yue' => $user->yue,
//                'jifen' => $user->jifen,
//                'sign_red'=>$user->sign_red
            ]);
        }, self::CACHE_TTS);
        
//       $many = User::field('magic,yue,jifen')->where('id', $userId)->find()->toArray();
       $userInfo = json_decode($userInfo);
//       // 数字字段 要实时更新
//       $userInfo->magic = $many['magic'];
//       $userInfo->yue = $many['yue'];
//       $userInfo->jifen = $many['jifen'];
        return $userInfo;
    }
