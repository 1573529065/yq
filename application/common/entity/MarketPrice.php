...
class MarketPrice extends Model
{
    ...
    public function getCurrentPrice()
    {
        ...
        $prices['prices']['max'] = Config::getValue('rcrc_max');
        $prices['prices']['min'] = Config::getValue('rcrc_min');
        $prices['prices']['current'] = Config::getValue('rcrc_current');
        $prices['prices']['current_china'] = self::getChinaMoney(Config::getValue('rcrc_current'), 3);
        return $prices;
    }
