        ...
        <table class="table table-bordered table-striped no-margin">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo htmlspecialchars_decode($entity['introduce']); ?></td>
                    <td class="text-center"> <a href="<?php echo url('certificate/c_edit',['id'=>$entity['id']]); ?>" class="btn btn-xs btn-info">编辑</a>
                   <a data-url="<?php echo url('certificate/c_del',['id'=>$entity['id']]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要删除吗？" class="btn btn-xs btn-danger">删除</a>
                    </td>
                </tr>
                <?php endforeach; else: ?>
