<?php /*a:1:{s:53:"/home/code/yq/application/admin/view/login/index.html";i:1556897673;}*/ ?>
<!doctype html>
        ...
        <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            <section class="col-md-8 col-md-offset-2 panel panel-primary" style="padding: 0">
                ...
                <div class="bg-white user pd-md" style="padding: 20px 15px">
                    <form role="form" action="" onsubmit="return false" style="margin-top: 15px">
...
<script>
    function login() {
        ...
        main.ajaxPost({username: username, password: password},"<?php echo url('login/login'); ?>");
    }
</script>
</html>
