...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <form class="form-horizontal" method="post" action="c_edit" role="form" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label">标题</label>
        <input type="hidden" value="<?php echo htmlentities($res['id']); ?>" name="id" >
                <div class="col-sm-5">
                    <input type="text" value="<?php echo htmlentities($res['title']); ?>" name="title" class="form-control"
                           placeholder="请输入标题">
                </div>
            </div>
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-5">
                   <textarea rows="5" cols="50" name='introduce' id='content'><?php echo htmlspecialchars_decode($res['introduce']); ?></textarea>
                </div>
            </div>
