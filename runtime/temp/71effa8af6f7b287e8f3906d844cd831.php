...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
          <div class="row clearfix " style="margin-bottom: 15px">
            <a type="button" href="/admin/home/b_add" class="btn btn-info">添加轮播</a>
        </div>
        <table class="table table-bordered table-striped no-margin">
            <thead>
                <tr>
                    <th class="text-center">ID</th>
                    <th class="text-center" style='width:15%'>图片</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="<?php echo htmlentities($entity['img']); ?>" target="target">
                            <img src="<?php echo htmlentities($entity['img']); ?>" style="width:150px;height: 50px">
                        </a></td>
                    <td class="text-center"><?php echo htmlentities($entity['title']); ?></td>
                    <td class="text-center"><?php echo htmlentities($entity['sort']); ?></td>
                    <td class="text-center"> <a href="<?php echo url('home/b_edit',['id'=>$entity['id']]); ?>" class="btn btn-xs btn-info">编辑</a>
                   <a data-url="<?php echo url('home/b_del',['id'=>$entity['id']]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要删除吗？" class="btn btn-xs btn-danger">删除</a>
                    </td>
                </tr>
                <?php endforeach; else: ?>
